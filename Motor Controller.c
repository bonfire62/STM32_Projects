...
void pwm_init(void) {
	...
	// enable mode
	GPIOB->MODER |= (2 << 16); // 	GPIO_MODER_MODER8_1
		GPIOB->AFR[1] |= 0x2;
  ...
  GPIOC->MODER |= GPIO_MODER_MODER4_1 | GPIO_MODER_MODER5_1;
    ...
    TIM16->CCR1 = 0;                        // Start PWM at 0% duty cycle
		...
		TIM16->BDTR |= TIM_BDTR_MOE; // SET master output enable
...
void encoder_init(void) {
     ...
     */ 
    TIM6->PSC = 79; // Change this!
    TIM6->ARR = 3750; // Change this!  
